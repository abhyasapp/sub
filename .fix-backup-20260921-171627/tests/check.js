...
const DRIVE = dctx.DRIVE, CH_NAMES = dctx.CH_NAMES;
const ids = [];
...
try {
  ctx = makeContext();
  ['config.js', 'version.js', 'shared.js', 'chapters-data.js', 'subjective_chapters.js', 'subjective-data.js',
   'app.js', 'objective.js', 'subjective.js'].forEach(f => vm.runInContext(read(f), ctx, { filename: f }));
